  ...
  <header>
    ...
    <div class="d-flex justify-content-end">
      <div class="card mb-3" style="max-width: 540px;">
        <div class="row g-0">
          <div class="col-md-4">
            <img src="E073EC9F-44F4-4E8E-965C-9A391454CC63.jpeg" class="img-fluid rounded-start" alt="...">
          </div>
          <div class="col-md-8">
            <div class="card-body">
              <h5 class="card-title">จัดทำโดย</h5>
              <p class="card-text">นายสาวภัทรวดี ปวงกาวี</p>
              <p class="card-text"><small class="text-muted">ม.6/13 เลขที่ 29 , 57905</small></p>
            </div>
          </div>
        </div>
      </div>
